    ...
    <>
      ...
      <section className="section-sm"><div className="container">
        <div className="legal-content">
          ...
          <h2>3. Hosting</h2>
          <p>This website is hosted by [Hosting Provider]. Server log files are processed on the basis of Art. 6(1)(f) GDPR.</p>
          ...
          <p style={{ marginTop: 40, fontStyle: 'italic', color: 'var(--text-muted)' }}>Last updated: [Date]</p>
        </div>
      </div></section>
    </>
  );
